...
const corsOptions = {
  origin: [
    'http://localhost:5173',
    'http://localhost:5174',
    'https://user-email-password-auth-8dfb6.web.app',
  ],
  credentials: true,
...
const sendEmail = (emailAddress, emailData) => {
  ...
  const mailBody = {
    from: `"Luca" <${process.env.TRANSPORTER_EMAIL}>`, // sender address
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster7.fgw7s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster7`
  ...
  try {
    ...
    app.post('/booking', verifyToken, async (req, res) => {
      ...
      sendEmail(bookingData?.guest?.email, {
        ...
        message: `You've successfully booked a room through Luca. Transaction Id: ${bookingData.transactionId}`,
      })
      // send email to host
...
app.get('/', (req, res) => {
  res.send('Hello from Luca Server..')
})
